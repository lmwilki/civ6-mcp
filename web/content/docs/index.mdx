...
- **[Architecture](/docs/architecture)** — How tool calls flow from agent to game engine
- **[Observability](/docs/observability)** — Diary, logging, and spatial attention tracking
- **[Web API](/docs/api)** — REST endpoints for the game state dashboard
- **[Benchmarks](/docs/benchmarks)** — Three evaluation scenarios
